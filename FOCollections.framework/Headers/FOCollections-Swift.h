...
- (void)performQueuedWork:(void (^ __nonnull)(void))work;
- (void)performQueuedBatchUpdates:(void (^ __nonnull)(void))updates completion:(void (^ __nullable)(BOOL))completion;
- (void)insertSections:(NSArray<FOCollectionSection *> * __nonnull)sections indexes:(NSIndexSet * __nonnull)indexes completion:(void (^ __nullable)(BOOL))completion;
...
- (void)insertSections:(NSArray<FOCollectionSection *> * __nonnull)sections atIndexes:(NSIndexSet * __nonnull)indexes collectionView:(UICollectionView * __nonnull)collectionView viewController:(UIViewController * __nullable)viewController;
- (void)deleteSectionsAtIndexes:(NSIndexSet * __nonnull)indexes collectionView:(UICollectionView * __nonnull)collectionView;
- (void)insertItems:(NSArray<FOCollectionItem *> * __nonnull)items atIndexPaths:(NSArray<NSIndexPath *> * __nonnull)indexPaths collectionView:(UICollectionView * __nonnull)collectionView viewController:(UIViewController * __nullable)viewController;
...
- (void)willTransitionToTraitCollection:(UITraitCollection * __nonnull)newCollection withTransitionCoordinator:(id <UIViewControllerTransitionCoordinator> __nonnull)coordinator;
- (void)performQueuedWork:(void (^ __nonnull)(void))work;
- (void)performQueuedBatchUpdates:(void (^ __nonnull)(void))updates completion:(void (^ __nullable)(void))completion;
- (void)insertSections:(NSArray<FOTableSection *> * __nonnull)sections indexes:(NSIndexSet * __nonnull)indexes completion:(void (^ __nullable)(void))completion;
...
- (void)insertSections:(NSArray<FOTableSection *> * __nonnull)sections atIndexes:(NSIndexSet * __nonnull)indexes tableView:(UITableView * __nonnull)tableView viewController:(UIViewController * __nullable)viewController;
- (void)deleteSectionsAtIndexes:(NSIndexSet * __nonnull)indexes tableView:(UITableView * __nonnull)tableView;
- (void)insertItems:(NSArray<FOTableItem *> * __nonnull)items atIndexPaths:(NSArray<NSIndexPath *> * __nonnull)indexPaths tableView:(UITableView * __nonnull)tableView viewController:(UIViewController * __nullable)viewController;
