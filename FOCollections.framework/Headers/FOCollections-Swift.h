...
- (void)insertSections:(NSArray<FOCollectionSection *> * _Nullable)sections indexes:(NSIndexSet * _Nonnull)indexes animated:(BOOL)animated;
- (void)deleteSectionsAtIndexes:(NSIndexSet * _Nonnull)indexes animated:(BOOL)animated;
- (void)insertItems:(NSArray<FOCollectionItem *> * _Nullable)items indexPaths:(NSArray<NSIndexPath *> * _Nullable)indexPaths animated:(BOOL)animated;
- (void)deleteItemsAtIndexPaths:(NSArray<NSIndexPath *> * _Nullable)indexPaths animated:(BOOL)animated;
- (void)appendItems:(NSArray<FOCollectionItem *> * _Nonnull)items toSectionAtIndex:(NSInteger)sectionIndex animated:(BOOL)animated;
- (void)prependItems:(NSArray<FOCollectionItem *> * _Nonnull)items toSectionAtIndex:(NSInteger)sectionIndex animated:(BOOL)animated;
